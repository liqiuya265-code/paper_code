...
omega_captured = false(1, M);  % 首次触发避障时捕获 ω
            ...
            if j == M
                ...
                if i == 1
                    [Ay_obs, Az_obs, last_psi_i_obs{i}] = compute_control_from_observer(...
                        ...
                        alpha, beta, p, q, m, miu, v, n, obs, oe, ne, lambda_info, x, zeros(M, M));
                else
                    [Ay_obs, Az_obs, last_psi_i_obs{i}] = compute_control_from_observer(...
                        t(i), z_observer, a_now, a_base, Vm', N, M, T, sigma_max, ...
                        alpha, beta, p, q, m, miu, v, n, obs, oe, ne, lambda_info, x, last_psi_i_obs{i-1});
                end
